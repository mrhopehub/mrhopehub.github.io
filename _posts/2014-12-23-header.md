...
# <@mrhopehub，堆栈设置>
#
# 从264行开始到2:处完成sp(放在dx中)的设置，2:到movzwl	%dx, %esp
# 完成ss、sp的装载
#
# </@mrhopehub，从264行开始到2:处完成对堆栈的检查、纠正>

	movw	%ss, %dx
	# <@mrhopehub>
	# 255行的结果为：%ax == %ds，264行的结果为：%dx == %ss，
...
# ds/es/ss/fs/gs的值均指向起始地址0x9 0000处，
